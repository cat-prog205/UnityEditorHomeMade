...
public sealed class AddTypeMenuAttribute : Attribute
{
    ...
    /// </summary>
    public string[] GetSplittedMenuName() { return !string.IsNullOrWhiteSpace(this.MenuName) ? this.MenuName.Split(k_Separeters, StringSplitOptions.RemoveEmptyEntries) : Array.Empty<string>(); }
